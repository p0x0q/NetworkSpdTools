...
namespace NetworkSpdTools
{
    public partial class FormNetworkSelect : Form
    {
        ...
        public FormNetworkSelect(Form1 f)
        {
            ...
            DLL.Event.Login += new EventHandler(ON_LOGIN);
            DLL.Event.Logout += new EventHandler(ON_LOGOUT);
        ...
        private void ON_LOGIN(object sender, System.EventArgs e)
        {
            userAccount1.Visible = false;
            if (error == "error")
            {
        ...
        private void ON_LOGOUT(object sender, System.EventArgs e)
        {
        }
        ...
        {
            userAccount1.initial.Enabled = true;
        }
